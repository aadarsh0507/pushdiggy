...
const WebsiteServices = () => {
  ...
  // Fetch website services from backend
  useEffect(() => {
    const fetchWebsiteServices = async () => {
      try {
        const res = await api.get('/services');
        const websiteServices = res.data.filter(service => service.category === 'website');
        setWebsiteImages(websiteServices);
        setLoading(false);
      } catch (err) {
  ...
  const handleSaveEdit = async () => {
    try {
      ...
      if (selectedImage && selectedImage._id === editingService._id) {
        const updatedService = websiteServices.find(service => service._id === editingService._id);
        if (updatedService) {
  ...
  const handleAddImage = async (e) => {
    ...
    try {
      ...
      formData.append('features', 'Website Services');
      formData.append('category', 'website');
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-gradient-to-br from-green-600 to-teal-600 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold">Website Services</h1>
                <p className="text-green-100">Professional web development and design solutions</p>
              </div>
            </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-medium text-gray-900">Add New Website Image</h3>
              <button
            ...
            <form onSubmit={handleAddImage} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="4"
                  className="mt-1 block w-full border border-gray-300 rounded-md p-2"
                  placeholder="Detailed description of the website service..."
                />
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden relative shadow-2xl">
            ...
            <div className="flex flex-col lg:flex-row">
              ...
              {/* Description Section */}
              <div className="lg:w-1/3 p-8 bg-gradient-to-br from-green-50 to-teal-50 overflow-y-auto max-h-[80vh]">
                <div className="mb-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-green-600">{selectedImage.price}</p>
                    </div>
                    <div className="bg-green-100 px-3 py-1 rounded-full">
                      <span className="text-green-800 text-sm font-medium">{selectedImage.category}</span>
                    </div>
                  </div>
                  ...
                  <div className="pt-4">
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-green-600 to-teal-600 text-white py-3 px-6 rounded-lg font-semibold hover:from-green-700 hover:to-teal-700 transition-all duration-300 shadow-lg"
                    >
                      Get Free Quote
                    </button>
                  </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Click on any website type to view detailed specifications and features.
          </p>
        </div>

                {loading ? (
          <div className="text-center py-12">
            <p className="text-gray-600 text-lg">Loading website services...</p>
          </div>
        ) : websiteImages.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {websiteImages.map((website) => (
              <div
                key={website._id}
              ...
              >
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                    <h3 className="text-white text-lg font-bold">{website.name}</h3>
                  </div>
                </div>
                ...
                {user && user.role === 'admin' && (
                  <div className="absolute top-2 right-2 flex gap-2">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        handleEditService(website);
                      }}
                      className="bg-green-600 text-white px-3 py-1 rounded-lg text-xs hover:bg-green-700 transition-colors shadow-lg"
                    >
                      Edit
                    </button>
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        handleDeleteService(website._id);
                      }}
          ...
          <div className="text-center py-12">
            <p className="text-gray-600 text-lg">No website services available at the moment.</p>
          </div>
        )}
        ...
        <div className="mt-16 text-center">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Our experts can design and develop a custom website tailored to your specific business requirements.
            </p>
