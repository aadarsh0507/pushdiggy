...
import { clients, supportRequests as initialSupportRequests } from '../data/sampleData';
...
const ClientDashboard = () => {
  ...
  const currentClient = clients.find(c => c.email === user?.email) || clients[0];
  const clientSupportRequests = supportRequests.filter(r => r.clientId === currentClient.id);
  ...
  const renderOverview = () => (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Welcome back, {currentClient.name}!</h2>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{currentClient.services.length}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-lg font-semibold text-green-600 capitalize">{currentClient.status}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{clientSupportRequests.length}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-6">
            ...
            <div className="space-y-4">
              {clientSupportRequests.slice(0, 3).map((request) => (
              ...
              {clientSupportRequests.length === 0 && (
  ...
  const renderServices = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {currentClient.services.map((serviceName, index) => (
          <div key={index} className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-gray-600 mb-4">
              Your {serviceName.toLowerCase()} service is running smoothly with 99.9% uptime.
            </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="font-semibold text-gray-900">$899/month</span>
            </div>
            <div className="flex justify-between items-center">
          ...
          <button className="w-full mt-6 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-200">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-3">
            {[
              { date: '2024-02-15', amount: '$899.00', status: 'Paid' },
              { date: '2024-01-15', amount: '$899.00', status: 'Paid' },
              { date: '2023-12-15', amount: '$899.00', status: 'Paid' }
            ].map((invoice, index) => (
